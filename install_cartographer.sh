...
wstool merge -t src ~/plato_ws/src/plato/installation_scripts/cartographer.rosinstall
wstool update -t src

# Install proto3 locally.
# Build and install in 'plato_ws/protobuf/install' proto3.
set -o errexit
#set -o verbose
VERSION="v3.4.1"
...
echo 'source ~/plato_ws/install_isolated/setup.bash' >> ~/.bashrc